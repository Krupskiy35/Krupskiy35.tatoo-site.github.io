...
var _navbar = __webpack_require__(330);

var _carousel = __webpack_require__(331);

var _tabs = __webpack_require__(332);

var _tabsDinamic = __webpack_require__(333);

var _taskListComponent = __webpack_require__(334);
...
var myTasks = new _taskListComponent.TaskList('.my-task-list');
...
var Navbar = function () {
    function Navbar(cssSelector) {
        ...
        this.navbarWrapper = document.querySelector(cssSelector);
        this.navbarControl = this.navbarWrapper.querySelector('.navbar-toggler');
        this.navbarControl.addEventListener('click', function () {
            _this.toggle();
        });
    }
    ...
    _createClass(Navbar, [{
        ...
        value: function toggle() {
            this.navbarWrapper.classList.toggle('navbar_open');
        }
    }]);
...
var TabsDinamic = function () {
    function TabsDinamic(cssSelector, tabsData) {
        _classCallCheck(this, TabsDinamic);

        this.rootElement = $(cssSelector);
    ...
    _createClass(TabsDinamic, [{
        ...
        value: function render() {
            ...
            var tabsControls = $('<div class="tabs__controls">');
            var tabsContents = $('<div class="tabs__contents">');

            this.tabsData.forEach(function (data, i) {
                var control = $('<div class="tabs__control">');
                var content = $('<div class="tabs__content">');

                control.html(data.title);
                control.attr('data-control-id', i);

                content.html(data.content);
                control.attr('data-content-id', i);

                if (_this.activeTabIndex === i) {
                ...
                tabsControls.append(control);
                tabsContents.append(content);
            });

            this.rootElement.append(tabsControls);
            this.rootElement.append(tabsContents);
        }
    }, {
        key: 'switchOff',
        value: function switchOff() {
            ...
            this.controls.forEach(function (item, i) {
                ...
                $(_this2.contents[i]).removeClass('active');
            });
        }
    }, {
        key: 'toggleTab',
        value: function toggleTab() {
            this.switchOff();
            $(this.controls[this.activeTabIndex]).addClass('active');
            $(this.contents[this.activeTabIndex]).addClass('active');
        }
    }, {
        key: 'handleEvents',
        value: function handleEvents() {
            ...
            this.controls.forEach(function (el) {
                ...
                jqEl.on('click', function () {
                    _this3.activeTabIndex = jqEl.attr('data-control-id');
                    _this3.toggleTab();
                });
            });
        }
...
exports.TabsDinamic = TabsDinamic;
...
var _taskList = __webpack_require__(335);

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var mainTemplate = '\n        <header class="task-list__header">\n            <h2 class="task-list__title">My tasks</h2>\n            <div class="task-list__input-wrapper">\n                <input class="task-list__input" type="text">\n            </div>\n        </header>\n        <main class="task-list__content">\n\n        </main>\n        <footer class="task-list__footer">\n          <div class=\'filters\'>\n            <span class="filter-group">\n              <input class="filter" type=\'radio\' id=\'all\' name=\'filters\' value=\'ALL\'><label for=\'all\'>all</label>\n            </span>\n            <span class=\'filter-group\'>\n              <input class="filter" type=\'radio\' id=\'completed\' name=\'filters\' value=\'COMPLETED\'><label for=\'completed\'>Completed</label>\n            </span>\n            <span class=\'filter-group\'>\n              <input class="filter" type=\'radio\' id=\'active\' name=\'filters\' value=\'ACTIVE\'><label for=\'active\'>Active</label>\n            </span>\n          </div>\n        </footer>\n    ';

var TaskList = function () {
    function TaskList(cssSelector) {
        _classCallCheck(this, TaskList);

        this._rootElement = $(cssSelector);
        this._rootElement.addClass('task-list');
        this._inputEl = null;
        this.init();
    }
    ...
    _createClass(TaskList, [{
        ...
        value: function addEventHandlers() {
            ...
            this._inputEl.on('keypress', function (e) {
                if (e.keyCode === 13) {
                    _this.addItem();
                }
            });
            this._contentEl.on('click', function (e) {
                ...
                if (targetEl.hasClass('task-list__checkbox')) {
                    var parentId = targetEl.closest('.task-list__item').attr('id');
                    _this.completeItem(parentId);
                }
            });

            this._filters.get().forEach(function (filterElem) {
                $(filterElem).on('change', function () {
                    _taskList.taskListModel.setFilter(filterElem.value);
                    _this.updateList();
                });
            });
        }
        ...
        value: function updateList() {
            ...
            _taskList.taskListModel.getItems().then(function (tasks) {
                _this2.renderList(tasks);
            });
        }
    }, {
        key: 'completeItem',
        value: function completeItem(id) {
            ...
            _taskList.taskListModel.completeItem(id).then(function (item) {
                _this3.replaceElement(item);
            }).catch(function () {
                _this3.showError();
            });
        }
        ...
        value: function renderStatic() {
            this._rootElement.html(mainTemplate);
            this._inputEl = $(this._rootElement.find('.task-list__input'));
            this._contentEl = $(this._rootElement.find('.task-list__content'));
            this._filters = $(this._rootElement.find('.filter'));
            this._filters.get().forEach(function (filterElement) {
                if (filterElement.value === _taskList.taskListModel.getFilter()) {
                    filterElement.setAttribute('checked', true);
                }
            });
        }
    }, {
        key: 'createElement',
        value: function createElement(newItem) {
            return $('<div class="task-list__item" id="' + newItem.id + '">\n                <input class="task-list__checkbox" type="checkbox" ' + (newItem.completed ? 'checked' : '') + '><span>' + newItem.title + '</span>\n            </div>');
        }
    }, {
        key: 'renderOne',
        value: function renderOne(newItem) {
            this._contentEl.append(this.createElement(newItem));
        }
    }, {
        key: 'replaceElement',
        value: function replaceElement(item) {
            var replacedEl = $(this._contentEl.find('#' + item.id));
            replacedEl.replaceWith(this.createElement(item));
        }
    }, {
        key: 'renderList',
        value: function renderList(tasks) {
            ...
            this._contentEl.html('');
            tasks.forEach(function (listItem) {
                _this4.renderOne(listItem);
            });
        }
    }, {
        key: 'addItem',
        value: function addItem() {
            ...
            var title = this._inputEl.val();
            _taskList.taskListModel.addItem(title).then(function (newItem) {
                if (_taskList.taskListModel.getFilter() !== 'COMPLETED') {
                    _this5.renderOne(newItem);
                }
            });
            this._inputEl.val('');
        }
...
var TaskListModel = function () {
    function TaskListModel() {
        _classCallCheck(this, TaskListModel);

        this.url = 'http://localhost:4001/list';
        this.items = [];
        this._activeFilter = 'COMPLETED';
    }

    _createClass(TaskListModel, [{
        key: 'getItem',
        ...
        key: 'setFilter',
        value: function setFilter(newFilterValue) {
            this._activeFilter = newFilterValue;
        ...
        value: function getItems() {
            ...
            return new Promise(function (resolve) {
                ...
                if (_this.items.length) {
                    resolve(_this.filterItems());
                } else {
                    _this._fetchItems().then(function (items) {
                        _this._setItems(items);
                        resolve(_this.filterItems());
                    });
                }
            });
        ...
        value: function addItem(text) {
            return this._createItem(text).then(function (newItem) {
                return newItem;
            });
        }
    }, {
        ...
        value: function completeItem(id) {
            ...
            return new Promise(function (resolve, reject) {
                var changedItem = _this2.items.filter(function (item) {
                    return String(item.id) === id;
                })[0];

                changedItem.completed = !changedItem.completed;
                _this2._updateItem(changedItem).then(function (updatedItem) {
                    resolve(updatedItem);
                }).catch(function () {
                    reject();
                });
        ...
        value: function _updateItem(item) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                xhr.open('PUT', _this4.url + '/' + item.id);
                xhr.setRequestHeader('Content-type', 'application/json; charset=utf-8');
                ...
                xhr.addEventListener('readystatechange', function () {
                    if (xhr.readyState === 4) {
                        if (xhr.status !== 200) {
                            ...
                            _this5._setItems(xhr.response);
                            var responseData = _this5.filterItems();
